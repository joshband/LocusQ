Title: WebView Documentation Summary
...
**Location:** `.codex/skills/skill_design_webview/WEBVIEW-PRODUCTION-GUIDE.md`
...
**Location:** `.codex/skills/skill_design_webview/KNOWN-ISSUES-AND-SOLUTIONS.md`
...
#### 3. **known-issues.yaml**
**Location:** `.codex/troubleshooting/known-issues.yaml`
...
**Location:** `.codex/troubleshooting/resolutions/webview-es6-modules-fail.md`
...
2. `.codex/troubleshooting/known-issues.yaml` (search)
3. `.codex/troubleshooting/resolutions/webview-*.md` (details)

### Legacy Documentation (May Be Outdated)
- `.codex/skills/skill_design_webview/SKILL.md` (old guide)
