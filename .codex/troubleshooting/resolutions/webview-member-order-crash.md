Title: WebView Plugin Crashes DAW - Member Declaration Order Issue
Document Type: Troubleshooting Resolution
Author: APC Codex
...
1. **Always use correct member order in templates**
   - Update `.codex/templates/webview/PluginEditor.h.template`
...
3. **Follow the checklist**
   - Use the WebView development checklist from `.codex/WEBVIEW_FRAMEWORK_FIXES.md`
