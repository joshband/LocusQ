...
| 52 | BL-082 | QA runner app library — upstream extraction to audio-dsp-qa-harness | P0 | **Done** (2026-03-20: LocusQ thin entrypoint + `BaseQARunner` parity are closed; follow-on cross-repo adoption can proceed independently) | G | — | BL-083, BL-084, BL-085 | [bl-082](done/bl-082-qa-runner-app-library.md) |
| 53 | BL-083 | Runtime-config contract enforcement — audio-dsp-qa-harness ScenarioExecutor | P0 | **Done** (2026-03-20: upstream executor contract is live and LocusQ no longer carries the local workaround) | G | — | — | [bl-083](done/bl-083-runtime-config-contract.md) |
| 54 | BL-084 | Profiling contract hardening — audio-dsp-qa-harness ScenarioExecutor | P0 | **Done** (2026-03-20: shared runner owns profiling attachment and LocusQ no longer carries the local workaround) | G | — | — | [bl-084](done/bl-084-profiling-contract-hardening.md) |
...
| 66 | BL-096 | Companion executable/core protocol reunification | P1 | **Done** (2026-03-20: executable and core protocol paths are reunified; local parity evidence is green) | E | BL-045, BL-072 | — | [bl-096](done/bl-096-companion-executable-core-protocol-reunification.md) |
| 67 | BL-097 | Editor bridge cadence tiering and calibration reload isolation | P1 | **Done** (2026-03-20: tiered bridge cadence, staged calibration reload, and bounded resource logging are live) | B | HX-05, BL-059, BL-074 | — | [bl-097](done/bl-097-editor-bridge-cadence-tiering-and-calibration-reload-isolation.md) |
