...
| 49 | BL-079 | APVTS parameter grouping and host hierarchy | P2 | In Validation (clean-checkout configure/build/smoke replay PASS; REAPER VST3 host gate PASS; REAPER AU host gate FAIL because `Mode` lands at index `1` instead of `0`) | F | BL-032 | — | [bl-079](bl-079-apvts-parameter-grouping-and-host-hierarchy.md) |
