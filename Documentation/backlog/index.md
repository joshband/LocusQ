...
Last Modified Date: 2026-03-19 (BL-085, BL-095, BL-098 promoted to Done; BL-079 Done-candidate pending host-view verification; BL-099..BL-101 remain the active open set)
...
| 37 | BL-067 | AUv3 app-extension lifecycle and host validation | P1 | In Validation (2026-03-19 local runtime-access contract replay PASS for profile/SOFA fallback paths; Apple signing and real host execution still blocked) | A | BL-048 (Done) | — | [bl-067](bl-067-auv3-app-extension-lifecycle-and-host-validation.md) |
...
| 49 | BL-079 | APVTS parameter grouping and host hierarchy | P2 | In Validation (clean-checkout configure/build/smoke replay PASS 2026-03-19 after the shared RT-safety fix; representative host-view verification still pending) | F | BL-032 | — | [bl-079](bl-079-apvts-parameter-grouping-and-host-hierarchy.md) |
