...
This runbook tracks **BL-066** (BL-066 Ambisonics + ADM Pilot Execution Intake). Current status: **Done**. In plain terms: Prepare owner-gated pilot execution intake package for BL-051 roadmap implementation once compatibility and mapping contracts are accepted, with explicit rollback and blocker governance.
...
| What is changing? | BL-066 Ambisonics + ADM Pilot Execution Intake |
| Why is this important? | Prepare owner-gated pilot execution intake package for BL-051 roadmap implementation once compatibility and mapping contracts are accepted, with explicit rollback and blocker governance. |
...
| Where is the source of truth? | Runbook: `Documentation/backlog/done/bl-066-ambisonics-adm-pilot-execution-intake.md` plus repo-local evidence under `TestEvidence/...`. |
