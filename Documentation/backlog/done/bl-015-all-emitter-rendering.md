...
This runbook tracks **BL-015** (BL-015: All-Emitter Realtime Rendering Closure). Current status: **Done**. In plain terms: Closed multi-emitter simultaneous processing with slot tolerance (renderer handles inactive/missing emitter slots gracefully).
