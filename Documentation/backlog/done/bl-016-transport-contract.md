...
This runbook tracks **BL-016** (BL-016: Visualization Transport Contract Closure). Current status: **Done**. In plain terms: Established the lock-free scene snapshot cadence and transport state contract between processBlock and WebView UI.
...
| Archived Runbook Path | `Documentation/backlog/done/bl-016-transport-contract.md` |
