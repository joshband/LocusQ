...
This runbook tracks **BL-008** (BL-008: Audio-Reactive RMS Overlays). Current status: **Done**. In plain terms: Added RMS ring overlays on emitters that respond to real-time audio levels, providing visual feedback of per-emitter energy.
...
| Archived Runbook Path | `Documentation/backlog/done/bl-008-rms-overlays.md` |
