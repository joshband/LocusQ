...
This runbook tracks **BL-003** (BL-003: Timeline Transport Controls Restore). Current status: **Done**. In plain terms: Restored play/pause/stop/scrub transport controls in production WebView UI for keyframe timeline playback.
...
| Archived Runbook Path | `Documentation/backlog/done/bl-003-timeline-transport.md` |
