...
This runbook tracks **BL-010** (BL-010: FDN Expansion Promotion). Current status: **Done**. In plain terms: Promoted the 4x4 Hadamard FDN reverb processor from experimental to production status with validated tonal stability.
