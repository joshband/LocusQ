...
This runbook tracks **BL/HX** (HX-03: REAPER Multi-Instance Stability Lane). Current status: **Done**. In plain terms: Validated multi-instance stability in REAPER — multiple LocusQ instances in the same project with shared SceneGraph singleton.
