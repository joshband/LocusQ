...
This runbook tracks **BL-043** (BL-043 FDN Sample-Rate Integrity). Current status: **Done**. In plain terms: Fix sample-rate-dependent FDN behavior and enforce sample-rate sweep validation so reverb timing and density remain consistent across 44.1/48/96/192kHz.
