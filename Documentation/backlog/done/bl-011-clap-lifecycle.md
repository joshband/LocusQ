...
This runbook tracks **BL-011** (BL-011: CLAP Lifecycle and CI/Host Closeout). Current status: **Done**. In plain terms: Completed full CLAP plugin format lifecycle — build, install, descriptor validation, clap-validator pass, QA lanes, REAPER discoverability.
