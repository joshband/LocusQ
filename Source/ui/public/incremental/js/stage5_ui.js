(() => {
  ...
  async function runIncrementalStage5SelfTest() {
    const report = {
  ...
  function primeFromCurrentState() {
    ...
    updateSceneStatusBadge();
    renderCounters();
    writeDiagnostics({ message: "stage5 ready" });
  }
  ...
  if (selfTestRequested) {
    ...
    window.setTimeout(() => {
      void runIncrementalStage5SelfTest();
    }, 900);
  } else {
    window.__LQ_SELFTEST_RESULT__ = {
      requested: false,
  ...
  window.runIncrementalStage5SelfTest = runIncrementalStage5SelfTest;
