...
inline constexpr std::array kParameterBridgeSpecs {
    ...
    ParameterBridgeSpec { ParameterScope::emitter, RelayKind::slider, "phys_out_transient_0" },
    ParameterBridgeSpec { ParameterScope::emitter, RelayKind::slider, "phys_out_transient_1" },
    ParameterBridgeSpec { ParameterScope::emitter, RelayKind::slider, "phys_out_transient_2" },
    ParameterBridgeSpec { ParameterScope::emitter, RelayKind::slider, "phys_out_transient_3" },
    ParameterBridgeSpec { ParameterScope::emitter, RelayKind::slider, "phys_out_transient_4" },
    ParameterBridgeSpec { ParameterScope::emitter, RelayKind::slider, "phys_out_transient_5" },
    ParameterBridgeSpec { ParameterScope::emitter, RelayKind::slider, "phys_out_transient_6" },
    ParameterBridgeSpec { ParameterScope::emitter, RelayKind::slider, "phys_out_transient_7" },
