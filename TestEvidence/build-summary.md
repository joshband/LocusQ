...
- BL-084:
  - `TestEvidence/bl084_profiling_contract_20260319T192556Z/status.tsv`
  - `TestEvidence/bl084_profiling_contract_20260319T192556Z/summary.md`
- BL-083:
...
- Physics runtime refinement:
  ...
  - `qa/reaper/reascripts/LocusQ_PhysicsAttractorSpread_Gate.lua`
  - `qa/reaper/reascripts/LocusQ_PhysicsAttractorCrossing_Gate.lua`
  - `qa/reaper/reascripts/LocusQ_PhysicsBoidsSpread_Gate.lua`
  - `qa/reaper/reascripts/LocusQ_PhysicsCollisionTransient_Gate.lua`
  - `scripts/reaper-phys-attractor-spread-gate-mac.sh`
  - `scripts/reaper-phys-attractor-crossing-gate-mac.sh`
  - `scripts/reaper-phys-boids-spread-gate-mac.sh`
